...
# Function to update record of the high score
...
# Function to keep track of the highest score
def load_high_socre():
    try:
...
def player_score(score, score_colour, hi_score):
    ...
    screen.blit(display_score, (10, 10))  # Cordinates for top left
...
def main_game_loop():
    ...
    # Load high score
    high_score = load_high_socre()
    print(f"high score test: {high_score}") # for testing purposes only
    ...
    while not quit_game:
        ...
        # Link speed to the player score
        if score > 3:
            speed = score
        else:
            speed = 3
        ...
        clock.tick(speed)  # set the speed which the snake is moving at which iteration of the game loop
